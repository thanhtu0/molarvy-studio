    ...
    return (
        <Section title="Images">
            ...
            <p className={cx('image-caption')}>
                There are far more images available for molarvy-studio, but these are the ones we felt would be most useful
                to you. If you have specific requests, please <Link to="mailto:contact@molarvy-studio.ch">contact us!</Link>
            </p>
        </Section>
    );
}
